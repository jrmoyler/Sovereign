...
export const BUILDINGS = {
  hq: {
    ...
    trains: ['worker', 'engineer', 'agent_swarm', 'strategist', 'gridwright', 'terraformer', 'relay_warden'],
    generates: { capital: 3.0, infra: 1.2, talent: 0.4 }, dropoff: true,
  ...
  capital_exchange: {
    ...
    generates: { capital: 4.5 }, trains: ['market_maker', 'consultant'],
  ...
  research_lab: {
    ...
    trains: ['researcher', 'biomedic'], researchNode: true, needsEnergy: true,
  ...
  security_hub: {
    ...
    trains: ['scout', 'security', 'robot', 'siege_android', 'sentinel',
      'compiler_daemon', 'pacesetter', 'juggernaut', 'pathfinder'],
  ...
  broadcast: {
    ...
    generates: { trust: 1.4 }, trains: ['media', 'influencer', 'worldsmith', 'mesmerist'],
  ...
  policy_office: {
    ...
    generates: { gov: 1.1 }, trains: ['legal', 'organizer', 'advocate'],
  ...
  habitat: {
    ...
    generates: { talent: 0.8 }, dropoff: true, trains: ['mentor'],
